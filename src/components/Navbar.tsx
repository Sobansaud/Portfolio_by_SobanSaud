            ...
            return (
              <motion.li
                ...
                className={`cursor-pointer ${
                  isActive ? 'text-indigo-600 underline underline-offset-4' : ''
                }`}
              >
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.ul
            ...
            className="md:hidden bg-white shadow-inner overflow-hidden px-6 py-6 space-y-5 text-center font-semibold text-lg"
          >
            {navLinks.map(({ name, href }) => (
              <li key={name}>
                <Link
                  ...
                  className={`block hover:text-indigo-600 transition-colors ${
                    pathname === href ? 'text-indigo-600 underline underline-offset-4' : ''
                  }`}
                >
                  {name}
                </Link>
